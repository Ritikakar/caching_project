...
public class CollectionsConcepts 
{
    ...
    public static void main(String[] args) 
    {
        ...
        private static void demonstrateList() 
        {
            ...
            // Vector: Thread-safe dynamic array (legacy class)// used in banks for security purposes. this is threadsafe. during money withdrawal in bank 
            //when we are taking out money at a time the vector dedicated to my name gets blocked. so no other person can withdraw money from my account at the same time.
        ...
        private static void demonstrateSet() 
        {
            ...
            // TreeSet: Red-black tree implementation, sorted order// all the left child have lesser weight and all right child have greater weight than parent node
        ...
        private static void demonstrateQueue() 
        {
            ...
            // PriorityQueue: Priority heap implementation//always returns the smallest elemnt first. here 1// output order is not constant
            ...
            // LinkedList as Queue: FIFO queue// as it is a linkedlist queue the order is constant
        ...
        private static void demonstrateMap() 
        {
            ...
            // TreeMap: Red-black tree implementation, sorted order// here for Phi Pi and e it is taking the ascii values of the alphabelts.
            // small e comes after capital letter according to the ascii codes.
        ...
        private static void demonstrateUtilityClasses() 
        {
                ...
                // Unmodifiable collections // this is used whn we have to share the list with various people but we want that none's code can change the elements I have added int the list
                ...
                // Synchronized collections // this is used whn we have to share list with many operations(multi-threaded) but we want that only one thread can access means only one person can access it at that particular time.
